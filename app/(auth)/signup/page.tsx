      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-700">
          <div className="mb-8">
            ...
            <p className="text-gray-300">Commencez gratuitement dès maintenant</p>
          </div>
          ...
          <form className="space-y-5">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <label className="relative flex items-center justify-center p-3 border-2 border-blue-600 bg-blue-900 rounded-lg cursor-pointer">
                  <input type="radio" name="userType" value="patient" className="sr-only" defaultChecked />
                  <span className="text-sm font-medium text-blue-300">Patient</span>
                </label>
                <label className="relative flex items-center justify-center p-3 border-2 border-gray-600 bg-gray-700 rounded-lg cursor-pointer hover:border-gray-500">
                  <input type="radio" name="userType" value="dentist" className="sr-only" />
                  <span className="text-sm font-medium text-gray-300">Dentiste</span>
                </label>
              </div>
            </div>
            ...
            <div>
              <label className="flex items-start gap-2">
                <input type="checkbox" className="w-4 h-4 mt-1 text-blue-600 bg-gray-700 border-gray-600 rounded focus:ring-blue-500" />
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-gray-800 text-gray-400">Ou s'inscrire avec</span>
            </div>
          </div>
