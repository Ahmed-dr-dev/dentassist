...
export default function DentistHeader({ user }: { user: any }) {
  ...
  return (
    <header className="border-b border-gray-700/50 backdrop-blur-sm bg-gray-900/80">
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
        <Link href="/dashboard/dentist" className="flex items-center gap-2">
        ...
        <div className="flex items-center gap-6">
          <Link 
            ...
            className={`transition ${isActive('/dashboard/dentist') ? 'text-blue-400 font-medium' : 'text-gray-300 hover:text-white'}`}
          >
            Tableau de bord
          </Link>
          <Link 
            href="/dashboard/dentist/appointments" 
            className={`transition ${isActive('/dashboard/dentist/appointments') ? 'text-blue-400 font-medium' : 'text-gray-300 hover:text-white'}`}
          >
            Rendez-vous
          </Link>
          <Link 
            href="/dashboard/dentist/patients" 
            className={`transition ${isActive('/dashboard/dentist/patients') ? 'text-blue-400 font-medium' : 'text-gray-300 hover:text-white'}`}
          >
            Patients
          </Link>
          <Link 
