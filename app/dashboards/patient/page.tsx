      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <Link
            ...
            className="flex items-center gap-4 bg-gradient-to-br from-blue-600 to-blue-500 rounded-xl p-6 text-white hover:shadow-lg hover:shadow-blue-600/50 transition cursor-pointer"
          >
            ...
            <h3 className="text-xl font-bold">{t('appointments.request')}</h3>
          </Link>
          ...
          >
            ...
            <h3 className="text-xl font-bold">{t('appointments.myAppointments')}</h3>
          </Link>

          <Link
            href="/dashboards/patient/prescriptions"
            className="flex items-center gap-4 bg-gradient-to-br from-green-600 to-green-500 rounded-xl p-6 text-white hover:shadow-lg hover:shadow-green-600/50 transition cursor-pointer"
          >
            <span className="flex-shrink-0 w-12 h-12 rounded-xl bg-white/20 flex items-center justify-center">
          ...
          >
            ...
            <h3 className="text-xl font-bold">{t('controls.title')}</h3>
          </Link>
        </div>
